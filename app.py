...
def root(userid, cursor):
    ...
    r = requests.get(url, proxies={
        "http": os.environ.get("httpProxyUrl"),#"http://qywiproxy-rotate:qywiErmWhatTheSigma6959@p.webshare.io:80/",
        "https":  os.environ.get("httpsProxyUrl")#"http://qywiproxy-rotate:qywiErmWhatTheSigma6959@p.webshare.io:80/"
    })
