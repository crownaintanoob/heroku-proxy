...
def root(userid, cursor):
    cursor = cursor if typeof(cursor) == "string" else ""
    url = "https://www.roblox.com/users/inventory/list-json?assetTypeId=34&cursor=" + cursor + "&itemsPerPage=3&pageNumber=1&userId=" + userid
